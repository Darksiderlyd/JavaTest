...
//			board = createFENBoard(game.getTag(FEN));
//			printBoard(board);
//		}
...
//	private static byte[][] createFENBoard(String fen) {
//		byte[][] bytes = new byte[7][7];//初始化每个格子都是EMPTY
//
//		String s;
//		int pos = 0, i = 0, iAdd;
//		int rowY = 0,colX = 0;
//		while(pos < 64 && i < fen.length()){
//			iAdd = 1;
//			s = fen.substring(i, i+1);
//			if(s.equals("k")){
//				bytes[colX][rowY] = BLACK_KING;
//                colX += 1;
//			} else if(s.equals("K")){
//				bytes[colX][rowY] = WHITE_KING;
//                colX += 1;
//			} else if(s.equals("q")){
//				bytes[colX][rowY] = BLACK_KING;
//                colX += 1;
